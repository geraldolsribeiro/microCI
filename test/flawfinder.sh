...
if docker image inspect intmain/microci_flawfinder:latest > /dev/null 2>&1 ; then  echo 'Imagem docker intmain/microci_flawfinder:latest está atualizada' >> .microCI.log
else
