...
if docker image inspect intmain/microci_cppcheck:latest > /dev/null 2>&1 ; then  echo 'Imagem docker intmain/microci_cppcheck:latest está atualizada' >> .microCI.log
else
