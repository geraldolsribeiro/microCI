...

  {
    (
      ...
      docker run \
        ...
        --attach stderr \
        --rm \
        --name microci_create_pdf_presentation_from_markdown \
        --workdir /data \
        ...
        00-introduction.md 01-body.md 02-conclusion.md 99-references.md  \
...
if docker image inspect pandoc/latex:latest > /dev/null 2>&1 ; then
  echo 'Docker image pandoc/latex:latest is already updated' >> .microCI.log
else
