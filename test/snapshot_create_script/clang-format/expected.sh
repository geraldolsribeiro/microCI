...
# ----------------------------------------------------------------------
# Standardizes code formatting using rules
# ----------------------------------------------------------------------
function step_format_c___code_with_clang_format() {
  local SECONDS=0
  local MICROCI_STEP_NAME="Format C++ code with clang-format"
  local MICROCI_STEP_DESCRIPTION="Standardizes code formatting using rules"
...

  {
    (
      ...
      echo ""
      echo ""
      echo "Step: Format C++ code with clang-format"
      ...
      docker run \
        ...
        --attach stderr \
        --rm \
        --name microci_format_c___code_with_clang_format_$(head -c 8 /proc/sys/kernel/random/uuid) \
        --network none \
...
function main() {
  ...
  step_format_c___code_with_clang_format
