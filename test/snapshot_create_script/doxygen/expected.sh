...
if microCI_should_pull_docker_image 'intmain/microci_doxygen'; then
  echo 'Updating intmain/microci_doxygen docker image...'
  docker pull intmain/microci_doxygen --quiet
fi
