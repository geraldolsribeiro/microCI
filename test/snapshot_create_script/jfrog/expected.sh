...
function step_save_artifact_to_jfrog_artifact() {
  ...
  local HOME="/tmp/"
  local JFROG_ACCESS_TOKEN="xxxxxx"
  local JFROG_URL="http://artifactory.example.com"

  {
    (
      ...
      docker run \
        ...
        --env HOME="/tmp/" \
        --env JFROG_ACCESS_TOKEN="xxxxxx" \
        --env JFROG_URL="http://artifactory.example.com" \
...
if microCI_should_pull_docker_image 'releases-docker.jfrog.io/jfrog/jfrog-cli-full-v2-jf'; then
  echo 'Updating releases-docker.jfrog.io/jfrog/jfrog-cli-full-v2-jf docker image...'
  docker pull releases-docker.jfrog.io/jfrog/jfrog-cli-full-v2-jf --quiet
fi
