...
# ----------------------------------------------------------------------
# Analyze the source code with flawfinder
# ----------------------------------------------------------------------
function step_flawfinder() {
  local SECONDS=0
  local MICROCI_STEP_NAME="Flawfinder"
  local MICROCI_STEP_DESCRIPTION="Analyze the source code with flawfinder"
...

  {
    (
      ...
      docker run \
        ...
        --attach stderr \
        --rm \
        --name microci_flawfinder_$(head -c 8 /proc/sys/kernel/random/uuid) \
        --network none \
