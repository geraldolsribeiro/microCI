...
# ----------------------------------------------------------------------
# This bash script was generated by microCI v0.34.1   
...
# ----------------------------------------------------------------------
{
  ...
  echo -e "[0;34m┃                          ░░░▀░░░░░░░░░░░░░                         ┃[0m"
  echo -e "[0;34m┃                          ░░░░░░░░░░░░░░░░░                         ┃[0m"
  echo -e "[0;34m┃                            microCI v0.34.1                         ┃[0m"
  echo -e "[0;34m┃                                                                    ┃[0m"
  echo -e "[0;34m┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛[0m"
  echo ""
  echo ""
...
function step_vhdl_source_code_formatter_and_beautifier() {
  ...
  local CI_PROJECT_NAMESPACE="mounted_sdr"
  local CI_SERVER_HOST="172.20.131.5"
  local ENV_1="1"
  local ENV_2="String with spaces"
  local ENV_YML_1="1"
  local ENV_YML_2="String with spaces"
  local KATIM_DOCKER_REGISTRY_IP="172.20.130.164"
  local MICROCI_MINIO_ACCESS_KEY="GveVl7bFvXQzQ0KRIWv4"
  local MICROCI_MINIO_SECRET_KEY="2H0iwIb9W8BZYEUHCLyFkINHL19LsVUDojH5K7zg"
  local MICROCI_MINIO_URL="http://172.20.130.164:9000"

  {
    (
      ...
      docker run \
        ...
        --attach stderr \
        --rm \
        --name microci_vhdl_source_code_formatter_and_beautifier \
        --network none \
        --workdir /microci_workspace \
        --env CI_PROJECT_NAMESPACE="mounted_sdr" \
        --env CI_SERVER_HOST="172.20.131.5" \
        --env ENV_1="1" \
        --env ENV_2="String with spaces" \
        --env ENV_YML_1="1" \
        --env ENV_YML_2="String with spaces" \
        --env KATIM_DOCKER_REGISTRY_IP="172.20.130.164" \
        --env MICROCI_MINIO_ACCESS_KEY="GveVl7bFvXQzQ0KRIWv4" \
        --env MICROCI_MINIO_SECRET_KEY="2H0iwIb9W8BZYEUHCLyFkINHL19LsVUDojH5K7zg" \
        --env MICROCI_MINIO_URL="http://172.20.130.164:9000" \
