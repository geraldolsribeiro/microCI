...
echo 'Atualizando imagem docker intmain/microci_plantuml:latest...'
if docker image inspect intmain/microci_plantuml:latest > /dev/null 2>&1 ; then  echo 'Imagem docker intmain/microci_plantuml:latest está atualizada' >> .microCI.log
else
