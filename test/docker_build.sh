...
# ----------------------------------------------------------------------
function step_build_docker_image() {
  local SECONDS=0
  local MICROCI_STEP_NAME="Build docker image"
  local MICROCI_STEP_DESCRIPTION="Builds a docker image"
...
echo 'Updating docker images...'
  ...
  echo 'Updating intmain/microci_docmd:0.3 docker image...' >> .microCI.log
  docker pull intmain/microci_docmd:0.3 --quiet 2>&1 >> .microCI.log
