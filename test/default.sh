...
# ----------------------------------------------------------------------
# This bash script was generated by microCI v0.33.1   
...
# ----------------------------------------------------------------------
{
  ...
  echo -e "[0;34m┃                          ░░░▀░░░░░░░░░░░░░                         ┃[0m"
  echo -e "[0;34m┃                          ░░░░░░░░░░░░░░░░░                         ┃[0m"
  echo -e "[0;34m┃                            microCI v0.33.1                         ┃[0m"
  echo -e "[0;34m┃                                                                    ┃[0m"
  echo -e "[0;34m┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛[0m"
  echo ""
  echo ""
...

  {
    (
      ...
      docker run \
        ...
        --attach stderr \
        --rm \
        --name microci_instalar_dependencias \
        --network none \
...
if docker image inspect node:16 > /dev/null 2>&1 ; then
  echo 'Docker image node:16 is already updated' >> .microCI.log
else
  echo 'Updating node:16 docker image...'
  docker pull node:16 2>&1 >> .microCI.log
fi
if docker image inspect ubuntu:18.04 > /dev/null 2>&1 ; then
  echo 'Docker image ubuntu:18.04 is already updated' >> .microCI.log
else
  echo 'Updating ubuntu:18.04 docker image...'
