...
# ----------------------------------------------------------------------
# This bash script was generated by microCI v0.42.0   
...
# ----------------------------------------------------------------------
{
  ...
  echo -e "[0;34m┃                          ░░░▀░░░░░░░░░░░░░                         ┃[0m"
  echo -e "[0;34m┃                          ░░░░░░░░░░░░░░░░░                         ┃[0m"
  echo -e "[0;34m┃                            microCI v0.42.0                         ┃[0m"
  echo -e "[0;34m┃                                                                    ┃[0m"
  echo -e "[0;34m┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛[0m"
  echo ""
  echo ""
...
function step_instalar_dependencias() {
  local SECONDS=0
  local MICROCI_STEP_NAME="Instalar dependências"
...

  {
    (
      ...
      docker run \
        ...
        --attach stderr \
        --rm \
        --name microci_instalar_dependencias_$(head -c 8 /proc/sys/kernel/random/uuid) \
        --network none \
...
function step_construir() {
  local SECONDS=0
  local MICROCI_STEP_NAME="Construir"
...

  {
    (
      ...
      docker run \
        ...
        --attach stderr \
        --rm \
        --name microci_construir_$(head -c 8 /proc/sys/kernel/random/uuid) \
        --network none \
        --workdir /microci_workspace \
        --env ENV1="xxx" \
        --env ENV2="yyy" \
...
echo 'Updating docker images...'
  echo 'Updating node:16 docker image...' >> .microCI.log
  docker pull node:16 --quiet 2>&1 >> .microCI.log
  echo 'Updating ubuntu:18.04 docker image...' >> .microCI.log
  docker pull ubuntu:18.04 --quiet 2>&1 >> .microCI.log
